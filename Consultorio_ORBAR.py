...
st.set_page_config(page_title="Clinica ORBAR", layout="wide", page_icon="🦷")
...
class RecetaPDF(FPDF):
    def header(self):
        ...
        self.cell(0, 6, 'Cédula Profesional: ', 0, 1, 'C')
        self.cell(0, 6, 'Gustavo Bas ', 0, 1, 'C')
...
def generar_receta_pdf(nombre_paciente, edad, medicamento, dosis, indicaciones):
    ...
    pdf.cell(0, 6, 'Cédula Profesional:', 0, 1, 'C')
...
def generar_recibo_pdf(nombre_paciente, concepto, monto):
    ...
    pdf.set_text_color(0, 96, 100)
    pdf.cell(0, 12, "CONSULTORIO DENTAL PLUS", ln=True, align="C")
    pdf.set_font("Arial", "", 12)
...
# ==================== MENÚ PRINCIPAL ====================
st.sidebar.title("🦷 Clinica ORBAR")
    ...
    with tab2:
        ...
        if df_pacientes.empty:
            ...
            with st.form("form_cita"):
                ...
                dentista = st.selectbox("Dentista*", ["Dr. Juan Pérez", "Dra. Ana López"])
